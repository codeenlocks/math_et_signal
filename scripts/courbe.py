...
def main() -> None:
    """
    Script principal pour le tracé des signaux de Strasbourg.
    ...
    plt.tight_layout()
    plt.savefig(f"../images/courbes/analyse_strasbourg_{start_year}_{end_year}.png", dpi=300, bbox_inches='tight')
    plt.show()
